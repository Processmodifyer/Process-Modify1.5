...
namespace ProcessModify
{
    public partial class HexEditForm : Form
    {
        ...
        private void Hex_panel_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            int randomBytes = random.Next(1, 10000);
            int randomInterval = random.Next(10, randomBytes / 4);
            int randomChunk = random.Next(1, randomInterval / 12);
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            int randomBytes = random.Next(1, 2000);
            int randomInterval = random.Next(5, randomBytes / 2);
            int randomChunk = random.Next(1, randomInterval / 5);
